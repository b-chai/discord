    ...
    const list = this.props.messages.map((message) => {
      return (
        <div className="message-credentials" key={message.id}>
          <button
            onClick={() => this.unhide(message.id)}
          ...
          <span className="time-message">{this.formattedTime(message)}</span>
          <br />
          ...
          <div className={`hide id-${message.id}`}>
            <button
              ...
              onClick={() =>
                App.cable.subscriptions.subscriptions[0].remove(message)
              }
    ...
    return this.checkPath() ? (
      ...
      <div className="message-container">
        <div className="channel-background">
          ...
          <div className="channel-subtext">
            {this.props.receiver
              ? `This is the beginning of your direct message history with @${this.props.receiver.username}`
              : null}
          </div>
          {this.allMessages()}
      ...
      <div className="message-container">
        <div className="channel-background">
          ...
          <div className="channel-subtext">
            This is the start of the #{this.props.currentChannel.channelName}{" "}
            channel
          </div>
          {this.allMessages()}
          <div className="empty-space" ref={this.bottom} />
