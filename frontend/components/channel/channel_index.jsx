...
class ChannelIndex extends React.Component {
  ...
  removeChannel(ele) {
    if (this.listChannels().length < 2) {
      ...
      return this.props
        .deleteChannel(ele.id)
        .then(
          this.props.history.replace(
            `/servers/${this.props.match.params.serverId}/${
              this.listChannels()[0].key
            }`
          )
        );
    }
  ...
  listChannels() {
    ...
    for (let i = 0; i < allChannels.length; i++) {
      if (allChannels[i].serverId === serverId)
            ...
            {/* <div className="dropdown">
              ...
              <div className="dropdown-content" style={{ display: "none" }}>
                ...
                <button
                  ...
                  onClick={() => this.removeServer(this.props.currentServer)}
                >
                  Delete Server
                </button>
              </div>
